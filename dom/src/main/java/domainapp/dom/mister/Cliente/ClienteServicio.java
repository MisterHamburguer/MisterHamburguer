...
public class ClienteServicio {
  ...
  //region > BuscarPorNombre (action)
    ...
    public static class CreateDomainEvent extends ActionDomainEvent<ClienteServicio> {
        @SuppressWarnings("deprecation")
		public CreateDomainEvent(final ClienteServicio source, final Identifier identifier, final Object... arguments) {
