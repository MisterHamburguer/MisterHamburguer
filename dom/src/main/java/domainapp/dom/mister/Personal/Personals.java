...
public class Personals {
    ...
    public static class CreateDomainEvent extends ActionDomainEvent<Personals> {
        @SuppressWarnings("deprecation")
		public CreateDomainEvent(final Personals source, final Identifier identifier, final Object... arguments) {
